		...
		for msgid in range(fromID, toID+1):
			...
			# bot
				...
				if acc is None:
					bot.send_message(message.chat.id,f"**String Session is not Set**", reply_to_message_id=message.id)
					return
				try: bot.send_message(message.chat.id, reply_to_message_id=message.id), handle_private(message,username,msgid)
...
USAGE = """**Download Restricted Files from Private/Public Channels.**"""
